...
if ALGORITHM == "kmeans":
    TRAINED_MODEL_PATH = Path("kmeans/bgl_pca128_k_params/model_kmeans_log.pkl")
    TRAINING_LABELS_PATH = Path("kmeans/bgl_pca128_k_params/cluster_labels.npy")
    TRAINING_EMBEDDINGS_PATH = Path("/media/bioinfo04/Expansion/2427051003_dataset_vector/after_preprocessed_bgl_embeddings.npy")
else:  # dbscan
    TRAINING_LABELS_PATH = Path("dbscan/bgl_model/dbscan_labels.npy")
    TRAINING_CONFIG_PATH = Path("dbscan/bgl_model/dbscan_config.npy")
    TRAINING_EMBEDDINGS_PATH = Path("/media/bioinfo04/Expansion/2427051003_dataset_vector/after_preprocessed_bgl_embeddings.npy")
...
TESTING_SETS = [
    {
        ...
        'embeddings': Path("/media/bioinfo04/Expansion/2427051003_dataset_vector_pca128_testing/after_preprocessed_bgl_normal_embeddings.npy"),
    ...
    },
    {
        ...
        'embeddings': Path("/media/bioinfo04/Expansion/2427051003_dataset_vector_pca128_testing/after_preprocessed_bgl_non_normal_embeddings.npy"),
