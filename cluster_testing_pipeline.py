...
TESTING_SETS = [
    {
        ...
        'embeddings': Path("/media/bioinfo04/Expansion/2427051003_dataset_vector_pca256_testing/after_preprocessed_bgl_normal_embeddings.npy"),
    ...
    },
    {
        ...
        'embeddings': Path("/media/bioinfo04/Expansion/2427051003_dataset_vector_pca256_testing/after_preprocessed_bgl_non_normal_embeddings.npy"),
