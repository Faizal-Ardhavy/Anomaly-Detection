...
def render_overview_2class(parsed: ParsedLog2, out_path: Path, lang_cfg: Dict[str, str]) -> None:
    # Mengubah grid menjadi 1 baris, 4 kolom dan membuat ukuran gambar lebih panjang
    fig, axes = plt.subplots(1, 4, figsize=(24, 6))

    # Kolom 1: Cluster Label Summary
    ax = axes[0]
    if parsed.cluster_label_summary:
        ...
        ax.set_title(lang_cfg["overview_cluster"], fontsize=16, fontweight="bold", color="black")
        ax.set_ylabel(lang_cfg["overview_cluster_ylabel"], fontsize=14, color="black")
        ax.tick_params(axis='both', labelsize=12, colors='black')
        ax.grid(axis="y", alpha=0.3)
    else:
        ax.axis("off")

    # Kolom 2: Teks Informasi Summary
    ax = axes[3]
    ax.axis("off")
    summary_lines = [
    ...
    ax.text(0.05, 0.95, "\n".join(summary_lines), va="top", ha="left", fontsize=16, color="black",
    ...
    if parsed.per_class_metrics:
        ...
        ax.set_ylim(0, 1)
        ax.set_ylabel("F1 Score", fontsize=14, color="black")
        ax.set_title(lang_cfg["overview_f1"], fontsize=16, fontweight="bold", color="black")
        ax.tick_params(axis='both', labelsize=12, colors='black')
        ax.grid(axis="y", alpha=0.3)
    else:
        ax.axis("off")

    # Kolom 4: Prediction Methods
    ax = axes[1]
    if parsed.per_method_metrics:
        ...
        ax.set_yscale("log")
        ax.set_ylabel("Samples", fontsize=14, color="black")
        ax.set_title(lang_cfg["overview_method"], fontsize=16, fontweight="bold", color="black")
